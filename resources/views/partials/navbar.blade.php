@php
    ...
    switch (true) {
        case str_contains($routeName, 'barang'):
            $formRoute = route('barang.form');
            break;
        case str_contains($routeName, 'kategori'):
            $formRoute = route('kategori.form');
            break;
        case str_contains($routeName, 'pemasok'):
            $formRoute = route('pemasok.form');
            break;
        default:
            $formRoute = '#';
    }
