    ...
    <div class="max-w-2xl m-auto">
        <div class="mb-8 mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                    <h2 class="text-3xl font-bold mb-1 text-gray-900 dark:text-gray-100">Detail Baranag</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Informasi baranag</p>
                </div>
            </div>
        </div>
        <div>
